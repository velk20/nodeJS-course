...
exports.getLatestAnimals = () =>
  Animal.find().sort({ _id: -1 }).limit(3).lean();

exports.getOne = (animalId) =>
  Animal.findById(animalId).populate('owner').lean();

exports.getAll = () => Animal.find().populate('owner').lean();

exports.edit = (animalId, newAnimal) =>
  Animal.findByIdAndUpdate(animalId, newAnimal).lean();
